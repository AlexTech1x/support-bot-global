...
bot.action('rus', (ctx) => ctx.editMessageText('1234Здравствуйте, Вас приветствует поддержка 1xPartners. Укажите, пожалуйста, свой email и ID (при наличии) и опишите свой вопрос:'))
